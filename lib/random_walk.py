...
def read_random_walk_sample(log_reader: LogReader) -> Optional[RandomWalkSample]:
    while True:
        ...
        return RandomWalkSample(
            ...
            round(compute_angle(gps_start.heading, gps_stop.heading), 4),
            round(compute_angle(gps_start.heading, gps_cooldown.heading), 4),
            round(compute_angle(gps_start.heading, gps_final.heading), 4),
            round(compute_angle(inertial_start.heading, inertial_stop.heading), 4),
            round(compute_angle(inertial_start.heading, inertial_cooldown.heading), 4),
            round(compute_angle(inertial_start.heading, inertial_final.heading), 4),
